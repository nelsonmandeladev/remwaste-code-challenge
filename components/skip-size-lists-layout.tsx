...
import { IconCalendar, IconCreditCard, IconLocation, IconShieldCheck, IconTrash, IconTruck } from "@tabler/icons-react";
...
export function SkipSizeListsLayout(props: SkipSizeListsLayoutProps) {
  ...
  return (
    ...
    >
      <Sidebar open={queryParams.filterFormOpen} setOpen={setOpen} animate={true}>
        <SidebarBody className="justify-between gap-10">
          <SkipFilterForm skips={SKIPS} />
        </SidebarBody>
      </Sidebar>
     <div id="main-body-id" className="px-4 xl:px-10 py-4 w-full overflow-y-auto space-y-5 relative">
